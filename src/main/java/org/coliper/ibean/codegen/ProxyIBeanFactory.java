...
public class ProxyIBeanFactory implements IBeanFactory {
  ...
  //@formatter:off     
    private static List<org.coliper.ibean.proxy.ExtensionSupport> DEFAULT_INTERFACE_SUPPORTS =
  ...
  //@formatter:on 
    ...
    public static class Builder {
        ...
        private List<org.coliper.ibean.proxy.ExtensionSupport> interfaceSupport = new ArrayList<>();
        ...
        public ProxyIBeanFactory build() {
            ProxyIBeanFactoryExtensionKit extendedInterfacesKit = new ProxyIBeanFactoryExtensionKit(
                    null/* this.interfaceSupport */);
