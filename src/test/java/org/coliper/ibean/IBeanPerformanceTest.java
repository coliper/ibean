...
public class IBeanPerformanceTest {
    ...
    private static void testClassic() {
        ...
        duration = System.currentTimeMillis() - start;
        durationPerCall = 1000_000.0 * duration / (double)CLASSIC_ITERATIONS;
        System.out.println("Setter call of primitive to classic bean takes " + durationPerCall + " ns");
        ...
        duration = System.currentTimeMillis() - start;
        durationPerCall = 1000_000.0 * duration / (double)CLASSIC_ITERATIONS;
        System.out.println("Setter call of object to classic bean takes " + durationPerCall + " ns");
    ...
    private static void testIBean() {
        ...
        duration = System.currentTimeMillis() - start;
        durationPerCall = 1000_000.0 * duration / (double)IBEAN_ITERATIONS;
        System.out.println("Setter call of primitive (cached) to IBean takes " + durationPerCall + " ns");
        ...
        duration = System.currentTimeMillis() - start;
        durationPerCall = 1000_000.0 * duration / (double)IBEAN_ITERATIONS;
        System.out.println("Setter call of primitive (uncached) to IBean takes " + durationPerCall + " ns");
